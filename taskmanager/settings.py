...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-taskflow-master-key-prod-change-me')
...
# Database configuration (Postgres on Render via DATABASE_URL, local SQLite fallback)
